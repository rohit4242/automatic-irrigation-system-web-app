...
const people = [
  { id: 1, name: "Wade Cooper",temp:45 },
  { id: 2, name: "Arlene Mccoy",temp:45 },
  { id: 3, name: "Devon Webb",temp:45 },
  { id: 4, name: "Tom Cook",temp:45 },
  { id: 5, name: "Tanya Fox",temp:45 },
  { id: 6, name: "Hellen Schmidt",temp:45 },
];
const SetCrops = () => {
  ...
  return (
    <section className="w-full h-screen mx-auto">
      <div className="flex flex-col items-center mx-4 rounded-md h-80 bg-slate-200/50">
        <h1 className="m-2 text-2xl font-medium text-teal-400">
          Set Your Crop
        </h1>
